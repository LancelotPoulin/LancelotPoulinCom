...
/*
Portfolio.php - Lancelot POULIN - 16.09.2017
Portfolio (Presentation and skills) page
*/
...
<html>
	<head>
		<title>Portfolio | Lancelot Poulin</title>
					...
					<article id="main">
						...
						<section id="intro" class="wrapper style1 special">
							<div class="inner">
								<header class="major">
									<h2>Presentation</h2>
									<p align="justify" id="presentation1" ><span class="image left"><img id="presentation4" alt="" /></span> <!-- From DB --> </p>
									<ul class="icons major">
									<li><span class="icon fa-user major style3"><span class="label">Portfolio</span></span></li>
									</ul>
									<p align="justify" id="presentation2"> <!-- From DB --> </p>		
									<ul class="icons major">
									<li><span class="icon fa-user major style3"><span class="label">Portfolio</span></span></li>
									</ul>
									<p align="justify" id="presentation3"><span class="image right"><img id="presentation5" alt="" /></span> <!-- From DB --> </p>
								</header>
							</div>
						</section>
						...
						<section class="wrapper style2 special">
							<div class="inner">
								<header class="major">
									<h2><?php if ($_SESSION['language'] === 'en') echo "Skills"; if ($_SESSION['language'] === 'fr') echo "Compétences"; ?></h2>
									<p><br /><?php if ($_SESSION['language'] === 'en') echo "Here are my IT skills"; if ($_SESSION['language'] === 'fr') echo "Voici mes compétences en informatique"; ?></p>
								</header>
								
								<ul class="features" id="skills">
									<!-- From DDB -->
								</ul>
							</div>
						</section>
						...
						<section id="cta" class="wrapper style3">
							<div class="inner">
								<header>
									<h3><?php if ($_SESSION['language'] === 'en') echo "Classic Curriculum Vitae"; if ($_SESSION['language'] === 'fr') echo "Curriculum Vitae classique"; ?></h3>
									<p><?php if ($_SESSION['language'] === 'en') echo "Download my curriculum vitae in PDF format or display it on Linkedin."; if ($_SESSION['language'] === 'fr') echo "Téléchargez mon curriculum vitae en format PDF ou affichez le sur Linkedin."; ?></p>
								</header>
								<ul class="actions vertical">
									<li><a href="images/CV_Lancelot_POULIN-PONNELLE.pdf" target="_blank" class="button fit special icon fa-download"><?php if ($_SESSION['language'] === 'en') echo "Download"; if ($_SESSION['language'] === 'fr') echo "Télécharger"; ?></a></li>
									<li><a href="https://www.linkedin.com/in/lancelot-poulin-ponnelle/" target="_blank" class="button fit icon fa-linkedin"><?php if ($_SESSION['language'] === 'en') echo "Display"; if ($_SESSION['language'] === 'fr') echo "Afficher"; ?></a></li>
								</ul>
							</div>
						</section>
