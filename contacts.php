...
/*
Contact.php - Lancelot POULIN - 16.09.2017
Constacts page
*/
...
<html>
	<head>
		<title>Contacts | Lancelot Poulin</title>
				...
				<!-- Main -->
					<article id="main">
						...
						<section class="wrapper style3">
							<div class="inner">
								<section>
									<h4><?php if ($_SESSION['language'] === 'en') echo "Please fill out the form below"; if ($_SESSION['language'] === 'fr') echo "Merci de remplir le formulaire ci-dessous"; ?></h4>
									<form method="post" id="EmailForm">
										<div class="row uniform">
											...
											<div class="8u 12u$(small)">
												<input type="checkbox" id="demo-copy" name="subscribe" checked>
												<label for="demo-copy"><?php if ($_SESSION['language'] === 'en') echo "Subscribe and receive latest news"; if ($_SESSION['language'] === 'fr') echo "Abonnez-vous et recevez les nouveautés"; ?></label>
											</div>
											<div class="5u 12u$(xsmall)">
												<input type="text" name="surname" value="" placeholder="<?php if ($_SESSION['language'] === 'en') echo "Surname"; if ($_SESSION['language'] === 'fr') echo "Prénom"; ?>" />
											</div>
											<div class="5u 12u$(xsmall)">
												<input type="text" name="name" value="" placeholder="<?php if ($_SESSION['language'] === 'en') echo "Name"; if ($_SESSION['language'] === 'fr') echo "Nom"; ?>" />
											</div>
											...
											<div class="6u 12u$(xsmall)">
												<div class="select-wrapper">
													<select name="category">
														<option value="0">- <?php if ($_SESSION['language'] === 'en') echo "Category"; if ($_SESSION['language'] === 'fr') echo "Catégorie"; ?> -</option>
														<option value="Informations">Informations</option>
														<option value="Collaboration">Collaboration</option>
														<option value="Other"><?php if ($_SESSION['language'] === 'en') echo "Other"; if ($_SESSION['language'] === 'fr') echo "Autre"; ?></option>
													</select>
												</div>
											</div>
											
											<div class="12u$">
												<textarea name="message" placeholder="<?php if ($_SESSION['language'] === 'en') echo "Enter your message"; if ($_SESSION['language'] === 'fr') echo "Entrer votre message"; ?>" rows="6"></textarea>
											</div>
											<div class="12u$">
												<ul class="actions">
													<li><div class="g-recaptcha" data-sitekey="6Lfvry8UAAAAAD8QbdLl8yAXheZ7Miyb0k3MaWw_"></div></li>
													<li><input type="submit" value="<?php if ($_SESSION['language'] === 'en') echo "Send message"; if ($_SESSION['language'] === 'fr') echo "Envoyer"; ?>" class="special" /></li>
